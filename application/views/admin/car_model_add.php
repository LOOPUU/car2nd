<?php $id = $this->uri->segment(3);?>
   ...
   <div class="wrap-box">
    ...
    <form action="<?php echo base_url('admin_management/car_model_add/'.$id.'');?>" method="post">
        <div class="row">
                ...
                <div class="wrap-box">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            ...
                            <label>ชื่อรุ่นรถ&nbsp;<span style="color:#DC3545;">*</span></label>
                            <input name="name_model_th" type="text" class="form-control" value="<?php echo set_value('name_model_th');?>">
                    ...
                    <div class="form-input">
                        ...
                        <div class="form-group">
                            <label>ชื่อรุ่นรถ&nbsp;<span style="color:#DC3545;">*</span></label>
                            <input name="name_model_en" type="text" class="form-control" value="<?php  echo set_value('name_model_en');?>">
