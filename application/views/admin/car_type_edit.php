    ...
    <div class="pt-3 pb-2 mb-3 border-bottom">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-10 mb-2">
                <h4 class="h4">แก้ไขประเภทรถ</h4>
            </div>
             <div class="col-sm-12 col-md-2 col-lg-2 mb-2">
               <a href="<?php echo base_url('admin_management/car_type_list');?>" class="btn btn-secondary btn-block">
                    ย้อนกลับ
                </a> 
            </div>
        </div>
...
<?php foreach ( $data as $result ) {    ?>
    ...
    <form action="<?php echo base_url('admin_management/car_type_edit/'.$result->car_type_id.'/'.$id);?>" method="post">
        <div class="row">
                ...
                <div class="wrap-box">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            <label>ประเภท&nbsp;<span style="color:#DC3545;">*</span></label>
                            <input name="name_type_th" type="text" class="form-control" value="<?php if(set_value("name_type_th")){echo set_value("name_type_th");}else{echo $result->name_type_th;}?>">
                    ...
                    <div class="form-input">
                        ...
                        <div class="form-group">
                            <label>ประเภท&nbsp;<span style="color:#DC3545;">*</span></label>
                            <input name="name_type_en" type="text" class="form-control" value="<?php if(set_value("name_type_en")){echo set_value("name_type_en");}else{echo $result->name_type_en;}?>">
