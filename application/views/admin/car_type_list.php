        ...
        <div class="table-responsive">
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 mb-2">
                        <a href="<?php echo base_url('admin_management/car_type_add/'.$id.'');?>" class="btn btn-dark btn-block">
                            <i class="fas fa-plus fa-fw"></i>เพิ่มประเภทรถ
                        </a>
                    </div>
                </div>
            </div>
            ...
            <table id="table"  class="table table-striped table-bordered" style="width:100%; border-top:0px solid transparent">
                     <thead class="thead-light text-center" >
                      <tr>
                        <th>ลำดับ</th>
                        <th>ประเภทรถ&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url('backend/images/thailand.png');?>" width=20px;></th>
                        <th>ประเภทรถ&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url('backend/images/english.png');?>" width=20px;></th>   
                    ...
                    <?php foreach ( $result as $row ) {     ?>
                        <tr>
                            ...
                            <td><div class="text-center"><?php echo $row->name_type_th; ?></div></td>
                            <td><div class="text-center"><?php echo $row->name_type_en; ?></div></td>
                           ...
                           <td> 
                                <div class="text-center">
                                    <a class="btn btn-info" style="width: 100%;" href="<?php echo base_url('admin_management/car_list/'.$row->car_type_id); ?>"><i class="fas fa-plus fa-fw"></i>ยี่ห้อรถ</a>
                                </div>
                            </td>
                            <td>
                                <div class="text-center">
                                    <div class="btn-group btn-group-toggle">
                                        <a class="btn btn-primary"  style="width: 100%;" href="<?php echo base_url('admin_management/car_type_edit/'.$row->car_type_id.'/'.$id); ?>"><i class="fas fa-edit fa-md fa-fw"></i></a>
                                        <a class="btn btn-danger"  style="width: 100%;" onclick="return confirm('ต้องการลบข้อมูลหรือไม่');" href="<?php echo base_url('admin_management/car_type_delete/'.$row->car_type_id.'/'.$id); ?>"><i class="fas fa-trash fa-md fa-fw"></i></a>
                                    </div>
                                </div>
                            </td>
