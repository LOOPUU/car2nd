...
<div class="pt-3 pb-2 mb-3 border-bottom">
    ...
    <!-- Content -->
   <?php echo form_open_multipart("admin_management/gallery_upload_image_multi/1/".$this->uri->segment(4)."?type=".$this->input->get('type')."&&car_type_id=".$this->input->get('car_type_id')."&&brand=".$this->input->get('brand')."&&car_id=".$this->input->get('car_id')."&&model=".$this->input->get('model')."&&car_model_id=".$this->input->get('car_model_id')."&&model_des=".$this->input->get('model_des')."&&car_model_des_id=".$this->input->get('car_model_des_id')."");?>
        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-3 mb-3">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="userfile" accept="image/*" onchange="loadFile(event)" size="20" class="custom-file-input" /> 
                    ...
                    <tbody>
                     <?php $no=1; foreach ($query as $row): ?>
                        ...
                        <td>
                            ...
                            <a target="_blank" href="<?php echo base_url('uploads_car/'.$row->thumb_name_multi.'');?>">
                       
                                <?php
                                    if($row->thumb_name_multi==""){
                                    echo "<img style='width: 200px;' src=".base_url('image/noimage100.gif').">";
                                    }elseif($row->thumb_name_multi!==""){
                                    echo "<img style='width: 200px;' src=".base_url('uploads_car/'.$row->thumb_name_multi.'').">";
                                    }
                                ?>
                            </a>
                        ...
                        <!-- <td>
                            <div class="text-center">
                                <div class="btn-group btn-group-toggle">
                                    ...
                                    <a class="btn btn-danger" style="width: 100%;" onclick="return confirm('ต้องการลบหรือไม่');" href="<?php echo base_url('admin_management/gallery_delete_image_multi/'.$id.'/'.$num.'/'. $row->id_image_multi); ?>">ลบ</a>
                                </div>
                            </div>
                        </td> -->
                      </tr>
