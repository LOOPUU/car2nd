    ...
    <div class="pt-3 pb-2 mb-3 border-bottom">
        <div class="row">
            <div class="col-sm-12 col-md-10 col-lg-10 mb-2">
                <h4 class="h4">แก้ไขเลขไมล์</h4>
            </div>
            <div class="col-sm-12 col-md-2 col-lg-2 mb-2">
              <a href="<?php echo base_url('admin_management/car_mile_list'); ?>" class="btn btn-secondary btn-block">ย้อนกลับ</a> 
            </div>
        </div>
...
<?php foreach ( $data as $result ) {    ?>
    ...
    <form action="<?php echo base_url('admin_management/car_mile_edit/'.$result->car_mile_id);?>" method="post">
        <div class="row">
                ...
                <div class="wrap-box">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            <label>ช่วงไมล์ (กม.)&nbsp;<span style="color:#DC3545;">*</span></label>
                            <div class="row">
                            <div class="col-sm-12 col-md-5 col-lg-5">
                                <input name="name_mile_min" type="number" class="form-control" value="<?php if(set_value("name_mile_min")){echo set_value("name_mile_min");}else{echo $result->name_mile_min;}?>">
                                <?php echo form_error('name_mile_min', '<div class="error" style="padding: 1% 0%;">', '</div>'); ?>
                            </div>
                            <div class="col-sm-12 col-md-2 col-lg-2">
                                <center style="padding:15px;">ระหว่าง</center>
                            </div>
                             <div class="col-sm-12 col-md-5 col-lg-5">
                                <input name="name_mile_max" type="number" class="form-control" value="<?php if(set_value("name_mile_max")){echo set_value("name_mile_max");}else{echo $result->name_mile_max;}?>">
                                <?php echo form_error('name_mile_max', '<div class="error" style="padding: 1% 0%;">', '</div>'); ?>
                            </div>
                            </div>
