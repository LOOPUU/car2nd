    ...
    <form action="<?php echo base_url('admin_management/car_price_add/');?>" method="post">
        <div class="row">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-5 col-lg-5">
                                <input name="name_price_min" type="number" class="form-control" value="<?php echo set_value('name_price_min');?>">
                                <?php echo form_error('name_price_min', '<div class="error" style="padding: 1% 0%;">', '</div>'); ?>
                            </div>
                            <div class="col-sm-12 col-md-2 col-lg-2">
                                <center style="padding:15px;">ถึง</center>
                            </div>
                             <div class="col-sm-12 col-md-5 col-lg-5">
                                <input name="name_price_max" type="number" class="form-control" value="<?php echo set_value('name_price_max');?>">
