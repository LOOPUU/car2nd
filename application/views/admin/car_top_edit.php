                                             ...
                                             <div class="form-input">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <select name="name_type" class="form-control" id="category" data-child="family" onchange="changeOption(event)">
                                                      ...
                                                      <option value="<?php echo $row->car_type_id;?>" <?php if(set_value('name_type')==$row->car_type_id OR $row->car_type_id==$data['car_type_id']){echo "selected";}?>>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="name" class="form-control" id="family" data-child="item" onchange="changeOption(event)">
                                                        ...
                                                        <option data-group="<?php echo $row->car_type_id;?>"  value="<?php echo $row->car_id;?>" <?php if(set_value('name')==$row->car_id OR $row->car_id==$data['car_id']){echo "selected";}?>>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <select name="name_model" class="form-control" id="item" data-child="item2" onchange="changeOption(event)">
                                                    ...
                                                    <?php  foreach($result_model as $row){?>
                                                      <option data-group="<?php echo $row->car_id;?>"  value="<?php echo $row->car_model_id;?>" <?php if(set_value('name_model')==$row->car_model_id OR $row->car_model_id==$data['car_model_id']){echo "selected";}?>>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="name_year_pro" id="year"  data-child="item2"  onchange="changeOption(event)" class="form-control">
                                                        ...
                                                        <option data-group="<?php echo $row->car_model_id;?>"  value="<?php echo $row->name_year_pro;?>" <?php if(set_value('name_year_pro')==$row->name_year_pro OR $row->name_year_pro==$data['name_year_pro']){echo "selected";}?>>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="name_model_des" class="form-control" id="item2" onchange="changeOption(event)">
                                                        ...
                                                        <option data-group="<?php echo $row->name_year_pro;?>"  value="<?php echo $row->car_model_des_id;?>" <?php if(set_value('name_model_des')==$row->car_model_des_id OR $row->car_model_des_id==$data['car_model_des_id']){echo "selected";}?>>
...
<script type="text/javascript">
    ...
    <?php
        ...
        }elseif(!empty($data['car_type_id'])){
          $category = $data['car_type_id'];
        }
        ...
        }elseif(!empty($data['car_model_id'])){
          $item = $data['car_model_id'];
        }

        if (!empty($this->input->post("name_year_pro"))) {
          $year = $this->input->post("name_year_pro");
        }elseif(!empty($data['name_year_pro'])){
          $year = $data['name_year_pro'];
        }

        if (!empty($this->input->post("name_model_des"))) {
          $item2 = $this->input->post("name_model_des");
        }elseif(!empty($data['car_model_des_id'])){
          $item2 = $data['car_model_des_id'];
        }
