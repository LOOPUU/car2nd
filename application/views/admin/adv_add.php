<style type="text/css">
  ...
  input[type=file]{
    ...
    <!-- Content -->
    <?php echo form_open_multipart('admin_management/adv_add');?>
                    ...
                    <div class="form-input">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status_id" class="form-control">
                                <option value="" <?php if(set_value('status_id')==""){echo "selected";}?>>กรุณาเลือกสถานะ</option>
                                <option value="1" <?php if(set_value('status_id')=="1"){echo "selected";}?>>เปิด</option>
                                <option value="2" <?php if(set_value('status_id')=="2"){echo "selected";}?>>ปิด</option>
                            </select> 
