    ...
    <div class="pt-3 pb-2 mb-3 border-bottom">
        <div class="row">
            <div class="col-sm-12 col-md-10 col-lg-10 mb-2">
                <h4 class="h4">เพิ่มความจุเครื่อง</h4>
            </div>
    ...
    <form action="<?php echo base_url('admin_management/car_capacity_add/');?>" method="post">
        <div class="row">
                ...
                <div class="wrap-box">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            ...
                            <input name="name_capacity_th" type="number" class="form-control" value="<?php echo set_value('name_capacity_th');?>">
                    ...
                    <div class="form-input">
                        ...
                        <div class="form-group">
                            <label>ความจุเครื่องยนต์&nbsp;<span style="color:#DC3545;">* หน่วย CC</span></label>
                            <input name="name_capacity_en" type="number" class="form-control" value="<?php  echo set_value('name_capacity_en');?>">
