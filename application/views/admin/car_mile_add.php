    ...
    <form action="<?php echo base_url('admin_management/car_mile_add/');?>" method="post">
        <div class="row">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-5 col-lg-5">
                                <input name="name_mile_min" type="number" class="form-control" value="<?php echo set_value('name_mile_min');?>">
                            ...
                            <div class="col-sm-12 col-md-2 col-lg-2">
                             ...
                             <div class="col-sm-12 col-md-5 col-lg-5">
                                <input name="name_mile_max" type="number" class="form-control" value="<?php echo set_value('name_mile_max');?>">
