<?php $car_type_id = $this->uri->segment(3); ?>  

<div class="pt-3 pb-2 mb-3 border-bottom">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-8 mb-2">
                <h4 class="h4">จัดการยี่ห้อรถ [ประเภท <?php echo $type['name_type_th'];?>]</h4>
            </div>
    ...
    <div class="title"><h6 class="h6">เครื่องมือจัดการ</h6></div>
        <div class="content">
            ...
            <div class="col-sm-12 col-md-12 col-lg-3 mb-3" <?php if($this->uri->segment(2)=="car_list" 
               ...
               <a class="bt" href="<?php echo base_url('admin_management/car_list/'.$car_type_id);?>">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 mb-2">
                        <a href="<?php echo base_url('admin_management/car_add/'.$car_type_id.'');?>" class="btn btn-dark btn-block">
                            <i class="fas fa-plus fa-fw"></i>เพิ่มยี่ห้อรถ
                        </a>
                    </div>
                </div>
            </div>
             <table id="table"  class="table table-striped table-bordered" style="width:100%; border-top:0px solid transparent">
                     <thead class="thead-light text-center" >
                      <tr>
                        ...
                        <th>ยี่ห้อรถ&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url('backend/images/thailand.png');?>" width=20px;></th>
                        <th>ยี่ห้อรถ&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url('backend/images/english.png');?>" width=20px;></th>   
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-center">
                                    <a class="btn btn-info" style="width: 100%;" href="<?php echo base_url('admin_management/car_model_list/'.$row->car_id); ?>"><i class="fas fa-plus fa-fw"></i>รุ่นรถ</a>
                                </div>
                            </td>
                            <td>
                                <div class="text-center">
                                    <div class="btn-group btn-group-toggle">
                                        <a class="btn btn-primary" style="width: 100%;" href="<?php echo base_url('admin_management/car_edit/'.$row->car_id.'/'.$car_type_id); ?>"><i class="fas fa-edit fa-md fa-fw"></i></a>
                                        <a class="btn btn-danger" style="width: 100%;" onclick="return confirm('ต้องการลบข้อมูลหรือไม่');" href="<?php echo base_url('admin_management/car_delete/'.$row->car_id.'/'.$car_type_id); ?>"><i class="fas fa-trash fa-md fa-fw"></i></a>
                                    </div>
                                </div>
                            </td>
                        </tr>
