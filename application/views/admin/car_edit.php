 <?php $car_type_id = $this->uri->segment(4); ?> 
    <div class="pt-3 pb-2 mb-3 border-bottom">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-10 mb-2">
                <h4 class="h4">แก้ไขยี่ห้อรถ</h4>
            </div>
             <div class="col-sm-12 col-md-2 col-lg-2 mb-2">
               <a href="<?php echo base_url('admin_management/car_list/'.$car_type_id.'');?>" class="btn btn-secondary btn-block">
                    ย้อนกลับ
                </a> 
            </div>
        </div>
...
<?php foreach ( $data as $result ) {    ?>
    ...
    <form action="<?php echo base_url('admin_management/car_edit/'.$result->car_id.'/'.$car_type_id);?>" method="post">
        <div class="row">
                ...
                <div class="wrap-box">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            ...
                            <input name="name_th" type="text" class="form-control" value="<?php if(set_value("name_th")){echo set_value("name_th");}else{echo $result->name_th;}?>">
                    ...
                    <div class="form-input">
                        ...
                        <div class="form-group">
                            <label>ชื่อยี่ห้อรถ&nbsp;<span style="color:#DC3545;">*</span></label>
                            <input name="name_en" type="text" class="form-control" value="<?php if(set_value("name_en")){echo set_value("name_en");}else{echo $result->name_en;}?>">
