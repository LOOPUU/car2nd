    ...
    <div class="pt-3 pb-2 mb-3 border-bottom">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-10 mb-2">
                <h4 class="h4">แก้ไขรุ่นรถ</h4>
            </div>
            <div class="col-sm-12 col-md-2 col-lg-2 mb-2">
               <a href="<?php echo base_url('admin_management/car_model_list/'.$id.'');?>" class="btn btn-secondary btn-block">
                    ย้อนกลับ
                </a> 
            </div>
        </div>
...
<?php foreach ( $data as $result ) {    ?>
    ...
    <form action="<?php echo base_url('admin_management/car_model_edit/'.$result->car_model_id.'/'.$id);?>" method="post">
        <div class="row">
                ...
                <div class="wrap-box">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            <label>ชื่อรุ่น&nbsp;<span style="color:#DC3545;">*</span></label>
                            <input name="name_model_th" type="text" class="form-control" value="<?php if(set_value("name_model_th")){echo set_value("name_model_th");}else{echo $result->name_model_th;}?>">
                            <?php echo form_error('name_model_th', '<div class="error" style="padding: 1% 0%;">', '</div>'); ?>
                    ...
                    <div class="form-input">
                        ...
                        <div class="form-group">
                            <label>ชื่อยี่ห้อรถ&nbsp;<span style="color:#DC3545;">*</span></label>
                            <input name="name_model_en" type="text" class="form-control" value="<?php if(set_value("name_model_en")){echo set_value("name_model_en");}else{echo $result->name_model_en;}?>">
                            <?php echo form_error('name_model_en', '<div class="error" style="padding: 1% 0%;">', '</div>'); ?>
                        </div>
