...
<div class="mobile-menu-handle"></div>
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> เว็บไซต์
                            <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                     <form action="<?php echo base_url('admin_management/setting');?>" method="post">
                        <div class="card card-block">
                            ...
                            <div class="form-group row">
                                ...
                                keyword : </label>
                                <div class="col-sm-10">
                                    <textarea  name="keyword_th" class="form-control boxed"><?php if(set_value("keyword_th")){echo set_value("keyword_th");}else{echo $data['keyword_th'];}?></textarea>
                                    <?php echo form_error('keyword_th', '<div class="error" style="padding: 1% 0%;">', '</div>'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                keyword : </label>
                                <div class="col-sm-10">
                                    <textarea  name="keyword_en" class="form-control boxed"><?php if(set_value("keyword_en")){echo set_value("keyword_en");}else{echo $data['keyword_en'];}?></textarea>
                                    <?php echo form_error('keyword_en', '<div class="error" style="padding: 1% 0%;">', '</div>'); ?>
                                </div>
                            </div>
