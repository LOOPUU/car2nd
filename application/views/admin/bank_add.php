    ...
    <div class="pt-3 pb-2 mb-3 border-bottom">
        <div class="row">
            <div class="col-sm-12 col-md-10 col-lg-10 mb-2">
                <h4 class="h4">เพิ่มธนาคาร/ดอกเบี้ย</h4>
            </div>
    ...
    <!-- Content -->
    <?php echo form_open_multipart('admin_management/bank_add');?>
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            <label>ชื่อธนาคาร&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url('backend/images/thailand.png');?>" width=20px;>&nbsp;<span style="color:#DC3545;">*</span></label>
                             <input name="bank_name_th" type="text" class="form-control" value="<?php echo set_value('bank_name_th');?>">
                         ...
                         <div class="form-group">
                            <label>ชื่อธนาคาร&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url('backend/images/english.png');?>" width=20px;>&nbsp;<span style="color:#DC3545;">*</span></label>
                             <input name="bank_name_en" type="text" class="form-control" value="<?php echo set_value('bank_name_en');?>">
                        ...
                        <div class="form-group">
                            <label>อัตราดอกเบี้ย 4 ปี&nbsp;<span style="color:#DC3545;">*(%)</span></label>
                             <input name="four_year" type="text" class="form-control" value="<?php echo set_value('four_year');?>">
                         ...
                         <div class="form-group">
                            <label>อัตราดอกเบี้ย 5 ปี&nbsp;<span style="color:#DC3545;">*(%)</span></label>
                             <input name="five_year" type="text" class="form-control" value="<?php echo set_value('five_year');?>">
                         ...
                         <div class="form-group">
                            <label>อัตราดอกเบี้ย 6 ปี&nbsp;<span style="color:#DC3545;">*(%)</span></label>
                             <input name="six_year" type="text" class="form-control" value="<?php echo set_value('six_year');?>">
                         ...
                         <div class="form-group">
                            <label>อัตราดอกเบี้ย 7 ปี&nbsp;<span style="color:#DC3545;">*(%)</span></label>
                             <input name="seven_year" type="text" class="form-control" value="<?php echo set_value('seven_year');?>">
