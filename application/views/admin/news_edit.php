...
<?php foreach ( $data as $result ) {    ?>
    ...
    <?php echo form_open_multipart('admin_management/news_edit/'.$result->news_id.'');?>
        <div class="row">
                ...
                <div class="wrap-box">
                    ...
                    <div class="form-input">
                        ...
                        <div class="form-group">
                           ...
                           <textarea name="description_th" class="form-control"><?php if(set_value("description_th")){echo set_value("description_th");}else{echo $result->description_th;}?></textarea>
                    ...
                    <div class="form-input">
                        ...
                        <div class="form-group">
                            <label>รายละเอียด&nbsp;<span style="color:#DC3545;">*</span></label>
                            <textarea name="description_en" class="form-control"><?php if(set_value("description_en")){echo set_value("description_en");}else{echo $result->description_en;}?></textarea>
                      ...
                      <div class="form-group">
                            ...
                            <div class="">
                                     <?php
                                        ...
                                        echo '<img id="output" style="width:25%;" src="'.base_url().'uploads/'.$result->img.'"/>';
                                    ?>
                            </div>
                       ...
                       <div class="form-group">
                            ...
                            <input name="position_id" type="number" class="form-control" value="<?php if(set_value("position_id")){echo set_value("position_id");}else{echo $result->position_id;}?>">
