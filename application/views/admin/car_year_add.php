...
<div class="pt-3 pb-2 mb-3 border-bottom">
    ...
    <form action="<?php echo base_url('admin_management/car_year_add/');?>" method="post">
        <div class="row">
                ...
                <div class="wrap-box">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            ...
                            <input name="name_year_min"  maxlength="4" type="text"  class="form-control" value="<?php echo set_value('name_year_min');?>">
