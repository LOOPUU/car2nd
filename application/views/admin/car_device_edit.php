...
<?php foreach ( $data as $result ) {    ?>
    ...
    <form action="<?php echo base_url('admin_management/car_device_edit/'.$result->device_id);?>" method="post">
        <div class="row">
                ...
                <div class="wrap-box">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            ...
                            <input name="device_name_th" type="text" class="form-control" value="<?php if(set_value("device_name_th")){echo set_value("device_name_th");}else{echo $result->device_name_th;}?>">
                        ...
                        <div class="form-group">
                            ...
                            <input name="device_name_en" type="text" class="form-control" value="<?php if(set_value("device_name_en")){echo set_value("device_name_en");}else{echo $result->device_name_en;}?>">
