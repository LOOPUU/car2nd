    ...
    <form action="<?php echo base_url('admin_management/car_gear_add/');?>" method="post">
        <div class="row">
                ...
                <div class="wrap-box">
                    ...
                    <div class="form-input">
                        <div class="form-group">
                            ...
                            <input name="name_gear_th" type="text" class="form-control" value="<?php echo set_value('name_gear_th');?>">
                    ...
                    <div class="form-input">
                        ...
                        <div class="form-group">
                            <label>เกียร์&nbsp;<span style="color:#DC3545;">*</span></label>
                            <input name="name_gear_en" type="text" class="form-control" value="<?php  echo set_value('name_gear_en');?>">
